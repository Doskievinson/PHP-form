...
<div id="mainContent">
	...
	<form action="form-action.php" method="post" name="signup" id="signup">
		...
		<p>
			What Do You Read?
	<br>
	<label><input name="publication[]" type="checkbox" id="publications_drf" value="Buzzfeed">Buzzfeed</label>
	<label><input name="publication[]" type="checkbox" id="publications_elle" value="Reddit">Reddit</label>
		</p>
		...
		<br>
		<textarea name="comments" id="comments" cols="52" rows="5"></textarea>
